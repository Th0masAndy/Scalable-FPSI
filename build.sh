...
python3 build.py --install=../out/install --sudo --system -DVOLE_PSI_ENABLE_BOOST=true -DVOLE_PSI_ENABLE_OPPRF=true -DVOLE_PSI_ENABLE_BITPOLYMUL=false -DVOLE_PSI_SODIUM_MONTGOMERY=false -DFETCH_SPARSEHASH=true -DCMAKE_PREFIX_PATH=/usr/local/
